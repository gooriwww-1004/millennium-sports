...
export default function TeamSelect({ label, value, onChange, onOpen, onClose }: Props) {
  ...
  return (
    <div ref={wrapRef} style={{ position: 'relative' }}>
      ...
      <button
        type="button"
        onClick={() => { const next = !open; setOpen(next); next ? onOpen?.() : onClose?.() }}
        style={{
          width: '100%', height: 52,
              ...
              filtered.map((team, i) => (
                <button key={team.id || i}
                  ...
                  style={{
                    ...
                    cursor: 'pointer', transition: 'background .12s', color: 'var(--t1)',
                    textAlign: 'left'
                  }}
